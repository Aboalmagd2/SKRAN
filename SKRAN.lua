...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SKRAN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("AV", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SKRAN -X kill
screen -S SKRAN ./SKRAN
done
]])  
file:close() 
...
local SKRAN_Msg = ''  
if msgs < 100 then 
SKRAN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SKRAN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SKRAN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SKRAN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SKRAN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SKRAN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SKRAN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SKRAN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SKRAN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SKRAN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SKRAN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SKRAN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SKRAN_Msg = 'رب التفاعل'  
end 
return SKRAN_Msg 
end
...
function plugin_SKRAN(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SKRAN and msg then
pre_msg = plugin.SKRAN(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSKRAN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SKRAN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SKRAN.lua')
os.execute('wget https://raw.githubusercontent.com/devid100/vvvvvv/main/SKRAN.lua')
...
send(msg.chat_id_, msg.id_,'◉  عدد الجروبات الان ← { '..#group..' }'..SKRANk..''..SKRAN..'\n◉  الان عدد الجروبات الحقيقي ← { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local SKRAN1_Msg = database:get(bot_id.."SKRAN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SKRAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if SKRAN_Msg and not Special(msg) then  
local SKRAN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SKRAN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."SKRAN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SKRAN:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SKRAN:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SKRAN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SKRAN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SKRAN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SKRAN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SKRAN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SKRAN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SKRAN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SKRAN:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SKRAN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SKRAN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◉ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "ELMAGD3")..")\n◉ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SKRAN:teh"..msg.chat_id_).."} بجانب اسمك\n◉ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local SKRANChengName = database:get(bot_id.."SKRAN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SKRANChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SKRANChengName..']')
database:del(bot_id.."SKRAN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SKRANChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."SKRAN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SKRANChengUserName = database:get(bot_id.."SKRAN:Cheng:UserName"..data.id_)
if not data.username_ then 
if SKRANChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SKRANChengUserName..']')
database:del(bot_id.."SKRAN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SKRANChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SKRAN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SKRANChengPhoto = database:get(bot_id.."SKRAN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SKRANChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."SKRAN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SKRANChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SKRAN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local UserName = (b.username_ or "SRC-SKRAN")
...
function Function_SKRAN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SKRAN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SKRAN, nil)
return false 
end
...
database:set(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◉ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SKRAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◉ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SKRAN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◉ ارسل الكلمه الان")  
database:set(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SKRAN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SKRAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SKRAN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SKRAN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SKRAN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ◉ قائمة المنع \n⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺\n"
for k,v in pairs(list) do  
local SKRAN_Msg = database:get(bot_id.."SKRAN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..SKRAN_Msg.."}\n"    
end  
if #list == 0 then  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◉ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SKRAN:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◉ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:SKRAN:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SKRAN:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SKRAN:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SKRAN:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SKRAN:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SKRAN:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◉ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:SKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"◉تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SKRAN:Add:Rd:Sudo:Text2"..text)   
...
send(msg.chat_id_, msg.id_,'['..SKRAN_Msg[math.random(#SKRAN_Msg)]..']') 
return false
end
if text == "بوت" then  
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 ]]..SKRAN_Msg[math.random(#SKRAN_Msg)]..[[ 
...
-- vardump(data) 
SKRANdx(msg.chat_id_, msg.id_, ' ◉ ايدي المجموعة ← ( '..msg.chat_id_..' )\n ◉ عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n ◉ عدد المحظورين ← ( *'..data.kicked_count_..' )*\n ◉ عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
SKRAN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SKRAN)
...
--------------------------------------------------------------------------------------------------------------
SourceSKRAN(data.message_,data)
plugin_SKRAN(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local SKRANAbot = database:get(bot_id.."SKRAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if SKRANAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◉ ["..SKRANAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SKRAN1_Msg = database:get(bot_id.."SKRAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if SKRAN1_Msg then    
send(msg.chat_id_, msg.id_," ◉ "..SKRAN1_Msg)
